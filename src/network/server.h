...
public:
    ...
    Server(boost::asio::io_context& io_context, uint16_t port, std::size_t thread_pool_size, system::StingInstance* instance)
        ...
        acceptor_.async_accept(
            [this](boost::system::error_code ec, tcp::socket socket) {
                if (!ec) {
                    ...
                    std::make_shared<Connection>(std::move(socket), instance_)->Start();   
                }
